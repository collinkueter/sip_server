...
{     
   ...
   protected RtpStreamSender newRtpStreamSender(InputStream is, String codec, int payload_type, float sample_rate, int frame_size, UdpSocket socket, String dest_addr, int dest_port) throws Exception
   ...
   protected RtpStreamReceiver newRtpStreamReceiver(OutputStream os, String codec, float sample_rate, UdpSocket socket)  throws Exception
